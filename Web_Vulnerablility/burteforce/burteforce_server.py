...
def burteforce_server(url):
    with open('C:/Users/ruany/Desktop/扫描 - 副本/Web_Vulnerablility/burteforce/user.txt', 'r') as user:
        for username in user:
            with open('C:/Users/ruany/Desktop/扫描 - 副本/Web_Vulnerablility/burteforce/口令', 'r') as passwd:
